...
export const OPERATION_TYPES: Record<string, string> = {
  ...
  BATCH_DELETE_LOTTERY_CODE: 'BATCH_DELETE_LOTTERY_CODE',

  // 抽奖操作
  ONLINE_LOTTERY: 'ONLINE_LOTTERY',
  OFFLINE_LOTTERY: 'OFFLINE_LOTTERY',
  EMAIL_DRAW_REQUEST: 'EMAIL_DRAW_REQUEST',
  ...
  KDOCS_CREATE_LOTTERY_CODE: 'KDOCS_CREATE_LOTTERY_CODE',
  REGENERATE_WEBHOOK_TOKEN: 'REGENERATE_WEBHOOK_TOKEN',
}
